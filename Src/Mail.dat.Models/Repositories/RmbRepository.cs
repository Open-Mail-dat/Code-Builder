...
namespace Mail.dat
{
	...
	public partial class RmbRepository : EntityFrameworkRepository<IRmb, Rmb, MaildatContext> 
	{
		...
		/// factory.
		/// </summary>
		public RmbRepository(MaildatContext context, IEntityFactory<IRmb> entityFactory)
			 : base(context, entityFactory)
		{
		}

		/// <summary>
		/// Returns the DbSet for the <see cref="Rmb"/> entity.
		/// </summary>
		protected override DbSet<Rmb> MyDbSet(MaildatContext context) => context.Rmb;
	}
}