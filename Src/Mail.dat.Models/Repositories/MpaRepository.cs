...
{
	/// <summary>
	/// Repository for the <see cref="Mpa"/> entity.
	/// </summary>
	...
	public partial class MpaRepository : EntityFrameworkRepository<IMpa, Mpa, MaildatContext> 
	{
		...
		/// factory.
		/// </summary>
		public MpaRepository(MaildatContext context, IEntityFactory<IMpa> entityFactory)
			 : base(context, entityFactory)
		{
		}

		/// <summary>
		/// Returns the DbSet for the <see cref="Mpa"/> entity.
		/// </summary>
		protected override DbSet<Mpa> MyDbSet(MaildatContext context) => context.Mpa;
	}
}