...
namespace Mail.dat
{
	...
	[MaildatFile(Version = "24-1", Revision = "1.3", Extension = "seg", File = "Segment Record", Summary = "Identifies specific mail list supplied for this job.", Description = "Identifies specific mail list supplied for this job.", LineLength = 277, ClosingCharacter = "#")]
	...
	public partial class Seg : MaildatEntity, ISeg 
	{
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "seg", FieldCode = "SEG-1001", FieldName = "Job ID", Start = 1, Length = 8, Required = true, Key = true, DataType = "A/N", Description = "See Header File's Job ID definition.", Type = "string", Format = "zfillnumeric", References = "HDR-1001")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "seg", FieldCode = "SEG-2000", FieldName = "SEG Record Status", Start = 273, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		[MaildatField(Version = "24-1", Extension = "seg", FieldCode = "SEG-2000", FieldName = "SEG Record Status", Start = 273, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		[MaildatField(Version = "25-1", Extension = "seg", FieldCode = "SEG-2000", FieldName = "SEG Record Status", Start = 273, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "seg", FieldCode = "SEG-1127", FieldName = "Reserve", Start = 274, Length = 3, Required = false, Key = false, DataType = "A/N", Description = "", Type = "string", Format = "leftjustify")]
