...
namespace Mail.dat
{
	...
	[MaildatFile(Version = "24-1", Revision = "1.3", Extension = "pdr", File = "Piece Detail Record", Summary = "Quantity, rate, weight, and destination per piece (manifest).", Description = "Quantity, rate, weight, and destination per piece (manifest). Provides piece level detail required of full service mailings; has additional capabilities beyond the Piece Barcode file; when used instead of the Piece Barcode file, acts as an extension of the PQT file.", LineLength = 138, ClosingCharacter = "#")]
	...
	public partial class Pdr : MaildatEntity, IPdr 
	{
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "pdr", FieldCode = "PDR-1001", FieldName = "Job ID", Start = 1, Length = 8, Required = true, Key = true, DataType = "A/N", Description = "", Type = "string", Format = "zfillnumeric", References = "HDR-1001")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "pdr", FieldCode = "PDR-2000", FieldName = "PDR Record Status", Start = 137, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		[MaildatField(Version = "24-1", Extension = "pdr", FieldCode = "PDR-2000", FieldName = "PDR Record Status", Start = 137, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		[MaildatField(Version = "25-1", Extension = "pdr", FieldCode = "PDR-2000", FieldName = "PDR Record Status", Start = 137, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
