...
namespace Mail.dat
{
	...
	[PrimaryKey("Id")]
	public partial class Pdr : MaildatEntity
	{
		/// <summary>
		/// Job ID (PDR-1001)
		/// </summary>
		...
		[Column("LineOfTravelSequenceNumber", Order = 7)]
		[Comment("PDR-1114")]
		[TypeConverter(typeof(MaildatIntegerConverter))]
		...
		[Column("LineOfTravelSeqDirectionCode", Order = 8)]
		[MaxLength(1)]
		[AllowedValues("A", "D")]
		[Comment("PDR-1115")]
		...
		[Column("WalkSequenceNumber", Order = 9)]
		[Comment("PDR-1116")]
		[TypeConverter(typeof(MaildatIntegerConverter))]
		...
		[Column("WastedOrShortagePieceIndicator", Order = 10)]
		[MaxLength(1)]
		...
		[Column("MailerIDOfBarcodeApplicator", Order = 13)]
		[MaxLength(9)]
		[Comment("PDR-1126")]
		...
		[Column("MoveUpdateMethod", Order = 14)]
		[MaxLength(1)]
		...
		[Column("ACSKeyLineData", Order = 15)]
		[MaxLength(16)]
		[Comment("PDR-1129")]
		...
		[Column("IMpbBarcodeConstructCode", Order = 17)]
		[MaxLength(1)]
		...
		[Column("MIDInIMbIsMoveUpdateSupplier", Order = 18)]
		[MaxLength(1)]
		[AllowedValues("Y")]
		[Comment("PDR-1132")]
		...
		[Column("PDRRecordStatus", Order = 19)]
		[Required]
		[MaxLength(1)]
		...
		protected override ILoadError[] OnLoadData(int fileLineNumber, byte[] line)
		{
			...
			this.JobID = line.Parse<Pdr, string>(p => p.JobID, returnValue);
			this.CQTDatabaseID = line.Parse<Pdr, int>(p => p.CQTDatabaseID, returnValue);
			this.PackageID = line.Parse<Pdr, string>(p => p.PackageID, returnValue);
			this.PieceID = line.Parse<Pdr, string>(p => p.PieceID, returnValue);
			this.PieceBarcode = line.Parse<Pdr, string>(p => p.PieceBarcode, returnValue);
			this.LineOfTravelSequenceNumber = line.Parse<Pdr, int>(p => p.LineOfTravelSequenceNumber, returnValue);
			this.LineOfTravelSeqDirectionCode = line.Parse<Pdr, string>(p => p.LineOfTravelSeqDirectionCode, returnValue);
			this.WalkSequenceNumber = line.Parse<Pdr, int>(p => p.WalkSequenceNumber, returnValue);
			this.WastedOrShortagePieceIndicator = line.Parse<Pdr, string>(p => p.WastedOrShortagePieceIndicator, returnValue);
			this.IMBarcode = line.Parse<Pdr, string>(p => p.IMBarcode, returnValue);
			this.MachineID = line.Parse<Pdr, string>(p => p.MachineID, returnValue);
			this.MailerIDOfBarcodeApplicator = line.Parse<Pdr, string>(p => p.MailerIDOfBarcodeApplicator, returnValue);
			this.MoveUpdateMethod = line.Parse<Pdr, string>(p => p.MoveUpdateMethod, returnValue);
			this.ACSKeyLineData = line.Parse<Pdr, string>(p => p.ACSKeyLineData, returnValue);
			this.CarrierRoute = line.Parse<Pdr, string>(p => p.CarrierRoute, returnValue);
			this.IMpbBarcodeConstructCode = line.Parse<Pdr, string>(p => p.IMpbBarcodeConstructCode, returnValue);
			this.MIDInIMbIsMoveUpdateSupplier = line.Parse<Pdr, string>(p => p.MIDInIMbIsMoveUpdateSupplier, returnValue);
			this.PDRRecordStatus = line.Parse<Pdr, string>(p => p.PDRRecordStatus, returnValue);
			this.ClosingCharacter = line.Parse<Pdr, string>(p => p.ClosingCharacter, returnValue);
