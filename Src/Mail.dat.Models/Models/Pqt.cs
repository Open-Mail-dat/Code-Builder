...
namespace Mail.dat
{
	...
	/// </summary>
	[MaildatFile(Version = "23-1", Revision = "0.5", Extension = "pqt", File = "PACKAGE QUANTITY RECORD", Summary = "Quantity and destination per package.", Description = "Quantity and destination per package.", LineLength = 70, ClosingCharacter = "#")]
	[MaildatFile(Version = "24-1", Revision = "1.3", Extension = "pqt", File = "PACKAGE QUANTITY RECORD", Summary = "Quantity and destination per package.", Description = "Quantity and destination per package.", LineLength = 70, ClosingCharacter = "#")]
	...
	public partial class Pqt : MaildatEntity, IPqt 
	{
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "pqt", FieldCode = "PQT-1001", FieldName = "Job ID", Start = 1, Length = 8, Required = true, Key = true, DataType = "A/N", Description = "See Header File's Job Id definition.", Type = "string", Format = "zfillnumeric", References = "HDR-1001")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "pqt", FieldCode = "PQT-1101", FieldName = "Package Carrier Route", Start = 29, Length = 4, Required = true, Key = false, DataType = "A/N", Description = "Example: C999, R999, B999, H999 as applicable.", Type = "string", Format = "leftjustify")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "pqt", FieldCode = "PQT-1115", FieldName = "Package Preparation Type", Start = 35, Length = 1, Required = false, Key = false, DataType = "A/N", Description = "Populate in the scenario when CSM Tray Preparation Type is set to M = Mixed).", Type = "enum", Format = "leftjustify")]
		...
		[Column("PackagePreparationType", Order = 8, TypeName = "TEXT")]
		[MaxLength(1)]
		[AllowedValues(" ", "L", "P")]
		[Comment("PQT-1115")]
		[TypeConverter(typeof(MaildatEnumConverter))]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "pqt", FieldCode = "PQT-1103", FieldName = "Number of Copies", Start = 36, Length = 5, Required = true, Key = false, DataType = "N", Description = "Number of copies within the specific package.", Type = "integer", Format = "zfill")]
		...
		[Column("NumberOfCopies", Order = 9, TypeName = "INTEGER")]
		[Required]
		[Comment("PQT-1103")]
		[TypeConverter(typeof(MaildatIntegerConverter))]
		[MaildatVersions("23-1", "24-1", "25-1")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "pqt", FieldCode = "PQT-1113", FieldName = "Bundle Charge Allocation", Start = 46, Length = 7, Required = false, Key = false, DataType = "N", Description = "9v999999 - proportion, rounded, (decimal point implied) This field is to be used for denoting the proportion of cost of its bundle that it's carrying.", Type = "decimal", Format = "zfill", Precision = 6)]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "pqt", FieldCode = "PQT-1114", FieldName = "Combo-Pack ID", Start = 53, Length = 6, Required = false, Key = false, DataType = "A/N", Description = "The unique code for this combo-pack within this package.", Type = "string", Format = "leftjustify")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "pqt", FieldCode = "PQT-2000", FieldName = "PQT Record Status", Start = 59, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		[MaildatField(Version = "24-1", Extension = "pqt", FieldCode = "PQT-2000", FieldName = "PQT Record Status", Start = 59, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		[MaildatField(Version = "25-1", Extension = "pqt", FieldCode = "PQT-2000", FieldName = "PQT Record Status", Start = 58, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "pqt", FieldCode = "PQT-1105", FieldName = "Reserve", Start = 60, Length = 10, Required = false, Key = false, DataType = "A/N", Description = "", Type = "string", Format = "leftjustify")]
