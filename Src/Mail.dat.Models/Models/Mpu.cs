...
namespace Mail.dat
{
	...
	[PrimaryKey("Id")]
	public partial class Mpu : MaildatEntity
	{
		/// <summary>
		/// Job ID (MPU-1001)
		/// </summary>
		...
		[Column("MailPieceUnitName", Order = 5)]
		[Required]
		[MaxLength(12)]
		[Comment("MPU-1101")]
		...
		[Column("MailPieceUnitDescription", Order = 6)]
		[MaxLength(30)]
		[Comment("MPU-1102")]
		...
		[Column("MailPieceUnitWeight", Order = 7)]
		[Required]
		[Precision(4)]
		[Comment("MPU-1103")]
		...
		[Column("MPUWeightSource", Order = 8)]
		[MaxLength(1)]
		...
		[Column("MPUWeightStatus", Order = 9)]
		[Required]
		[MaxLength(1)]
		...
		[Column("MailPieceUnitLength", Order = 10)]
		[Precision(4)]
		[Comment("MPU-1106")]
		[TypeConverter(typeof(MaildatDecimalConverter))]
		...
		[Column("MailPieceUnitWidth", Order = 11)]
		[Precision(4)]
		[Comment("MPU-1107")]
		[TypeConverter(typeof(MaildatDecimalConverter))]
		...
		[Column("MailPieceUnitThickness", Order = 12)]
		[Precision(4)]
		[Comment("MPU-1108")]
		[TypeConverter(typeof(MaildatDecimalConverter))]
		...
		[Column("MailPieceUnitClass", Order = 13)]
		[Required]
		[MaxLength(1)]
		...
		[Column("MailPieceUnitRateType", Order = 14)]
		[Required]
		[MaxLength(2)]
		...
		[Column("MailPieceUnitProcessingCategory", Order = 16)]
		[Required]
		[MaxLength(2)]
		...
		[Column("CoPalletizationCode", Order = 18)]
		[Required]
		[MaxLength(2)]
		[Comment("MPU-1116")]
		...
		[Column("MachinabilityIndicator", Order = 19)]
		[Required]
		[MaxLength(1)]
		[AllowedValues("N", "U", "Y")]
		[Comment("MPU-1123")]
		...
		[Column("PreDenominatedAmount", Order = 20)]
		[Precision(1)]
		[Comment("MPU-1124")]
		[TypeConverter(typeof(MaildatDecimalConverter))]
		...
		[Column("PostageAffixedType", Order = 21)]
		[MaxLength(1)]
		[AllowedValues("M", "S")]
		[Comment("MPU-1125")]
		...
		[Column("StandardParcelType", Order = 22)]
		[MaxLength(1)]
		...
		[Column("UserOptionField", Order = 23)]
		[MaxLength(20)]
		[Comment("MPU-1129")]
		...
		[Column("MoveUpdateSupplierCRID", Order = 24)]
		[MaxLength(12)]
		[Comment("MPU-1130")]
		...
		[Column("PieceUniquenessManagerCRID", Order = 25)]
		[MaxLength(12)]
		[Comment("MPU-1131")]
		...
		[Column("MPURecordStatus", Order = 26)]
		[Required]
		[MaxLength(1)]
		...
		[Column("GroupedExtraServiceType", Order = 27)]
		[MaxLength(1)]
		[AllowedValues("B", "F")]
		[Comment("MPU-1133")]
		...
		[Column("GroupedExtraServiceBarcode", Order = 28)]
		[MaxLength(34)]
		[Comment("MPU-1134")]
		...
		[Column("IMpbBarcodeConstructCode", Order = 29)]
		[MaxLength(1)]
		...
		[Column("ClosingCharacter", Order = 31)]
		[Required]
		[MaxLength(1)]
		[AllowedValues("#")]
		[Comment("MPU-9999")]
		...
		protected override ILoadError[] OnLoadData(int fileLineNumber, byte[] line)
		{
			...
			this.JobID = line.Parse<Mpu, string>(p => p.JobID, returnValue);
			this.SegmentID = line.Parse<Mpu, string>(p => p.SegmentID, returnValue);
			this.MailPieceUnitID = line.Parse<Mpu, string>(p => p.MailPieceUnitID, returnValue);
			this.MailPieceUnitName = line.Parse<Mpu, string>(p => p.MailPieceUnitName, returnValue);
			this.MailPieceUnitDescription = line.Parse<Mpu, string>(p => p.MailPieceUnitDescription, returnValue);
			this.MailPieceUnitWeight = line.Parse<Mpu, decimal>(p => p.MailPieceUnitWeight, returnValue);
			this.MPUWeightSource = line.Parse<Mpu, string>(p => p.MPUWeightSource, returnValue);
			this.MPUWeightStatus = line.Parse<Mpu, string>(p => p.MPUWeightStatus, returnValue);
			this.MailPieceUnitLength = line.Parse<Mpu, decimal>(p => p.MailPieceUnitLength, returnValue);
			this.MailPieceUnitWidth = line.Parse<Mpu, decimal>(p => p.MailPieceUnitWidth, returnValue);
			this.MailPieceUnitThickness = line.Parse<Mpu, decimal>(p => p.MailPieceUnitThickness, returnValue);
			this.MailPieceUnitClass = line.Parse<Mpu, string>(p => p.MailPieceUnitClass, returnValue);
			this.MailPieceUnitRateType = line.Parse<Mpu, string>(p => p.MailPieceUnitRateType, returnValue);
			this.RateSchedule = line.Parse<Mpu, string>(p => p.RateSchedule, returnValue);
			this.MailPieceUnitProcessingCategory = line.Parse<Mpu, string>(p => p.MailPieceUnitProcessingCategory, returnValue);
			this.MPUSurcharge = line.Parse<Mpu, string>(p => p.MPUSurcharge, returnValue);
			this.CoPalletizationCode = line.Parse<Mpu, string>(p => p.CoPalletizationCode, returnValue);
			this.MachinabilityIndicator = line.Parse<Mpu, string>(p => p.MachinabilityIndicator, returnValue);
			this.PreDenominatedAmount = line.Parse<Mpu, decimal>(p => p.PreDenominatedAmount, returnValue);
			this.PostageAffixedType = line.Parse<Mpu, string>(p => p.PostageAffixedType, returnValue);
			this.StandardParcelType = line.Parse<Mpu, string>(p => p.StandardParcelType, returnValue);
			this.UserOptionField = line.Parse<Mpu, string>(p => p.UserOptionField, returnValue);
			this.MoveUpdateSupplierCRID = line.Parse<Mpu, string>(p => p.MoveUpdateSupplierCRID, returnValue);
			this.PieceUniquenessManagerCRID = line.Parse<Mpu, string>(p => p.PieceUniquenessManagerCRID, returnValue);
			this.MPURecordStatus = line.Parse<Mpu, string>(p => p.MPURecordStatus, returnValue);
			this.GroupedExtraServiceType = line.Parse<Mpu, string>(p => p.GroupedExtraServiceType, returnValue);
			this.GroupedExtraServiceBarcode = line.Parse<Mpu, string>(p => p.GroupedExtraServiceBarcode, returnValue);
			this.IMpbBarcodeConstructCode = line.Parse<Mpu, string>(p => p.IMpbBarcodeConstructCode, returnValue);
			this.Reserved = line.Parse<Mpu, string>(p => p.Reserved, returnValue);
			this.ClosingCharacter = line.Parse<Mpu, string>(p => p.ClosingCharacter, returnValue);
