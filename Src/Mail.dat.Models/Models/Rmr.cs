...
namespace Mail.dat
{
	...
	[MaildatFile(Version = "24-1", Revision = "1.3", Extension = "rmr", File = "Referenceable Mail Record", Summary = "Reference-able Mail to provide digital content at the piece or version level.", Description = "Reference-able Mail to provide digital content at the piece or version level.", LineLength = 311, ClosingCharacter = "#")]
	[MaildatFile(Version = "25-1", Revision = "0.3", Extension = "rmr", File = "Referenceable Mail Record", Summary = "Reference-able Mail to provide digital content at the piece or version level.", Description = "Reference-able Mail to provide digital content at the piece or version level. Records identify digital campaigns and enhances capabilities of the USPS Informed Delivery program.", LineLength = 311, ClosingCharacter = "#")]
	...
	public partial class Rmr : MaildatEntity, IRmr 
	{
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "rmr", FieldCode = "RMR-1001", FieldName = "Job ID", Start = 1, Length = 8, Required = true, Key = true, DataType = "A/N", Description = "See Header File's Job ID definition.", Type = "string", Format = "zfillnumeric", References = "HDR-1001")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "rmr", FieldCode = "RMR-2000", FieldName = "RMR Record Status", Start = 310, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		[MaildatField(Version = "24-1", Extension = "rmr", FieldCode = "RMR-2000", FieldName = "RMR Record Status", Start = 310, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		[MaildatField(Version = "25-1", Extension = "rmr", FieldCode = "RMR-2000", FieldName = "RMR Record Status", Start = 310, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
