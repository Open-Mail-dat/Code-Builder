...
namespace Mail.dat
{
	...
	[MaildatFile(Version = "24-1", Revision = "1.3", Extension = "upa", File = "un-coded parcels address", Summary = "Un-coded parcels address record (linked to PDR).", Description = "Un-coded parcels address record (linked to PDR). Un-Coded Parcel Address file: records addresses for the un-coded parcels. (Links with .pdr ONLY).", LineLength = 135, ClosingCharacter = "#")]
	...
	public partial class Upa : MaildatEntity, IUpa 
	{
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "upa", FieldCode = "UPA-1001", FieldName = "Job ID", Start = 1, Length = 8, Required = true, Key = true, DataType = "A/N", Description = "", Type = "string", Format = "zfillnumeric", References = "HDR-1001")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "upa", FieldCode = "UPA-2000", FieldName = "UPA Record Status", Start = 133, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		[MaildatField(Version = "24-1", Extension = "upa", FieldCode = "UPA-2000", FieldName = "UPA Record Status", Start = 133, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		[MaildatField(Version = "25-1", Extension = "upa", FieldCode = "UPA-2000", FieldName = "UPA Record Status", Start = 133, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "upa", FieldCode = "UPA-1120", FieldName = "Reserve", Start = 134, Length = 1, Required = false, Key = false, DataType = "A/N", Description = "", Type = "string", Format = "leftjustify")]
