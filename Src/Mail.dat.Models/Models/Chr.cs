...
namespace Mail.dat
{
	...
	[MaildatImport(Order = 25, Version = "23-1")]
	...
	public partial class Chr : MaildatEntity, IChr 
	{
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "chr", FieldCode = "CHR-1001", FieldName = "Job ID", Start = 1, Length = 8, Required = true, Key = true, DataType = "A/N", Description = "", Type = "string", Format = "zfillnumeric", References = "HDR-1001")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "chr", FieldCode = "CHR-1002", FieldName = "Certificate of Mailing Header ID", Start = 9, Length = 8, Required = true, Key = true, DataType = "A/N", Description = "Unique ID of the Certificate of Mailing Header Record.", Type = "string", Format = "zfillnumeric")]
		...
		/// Form Type (CHR-1101)
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "chr", FieldCode = "CHR-1101", FieldName = "Form Type", Start = 17, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "chr", FieldCode = "CHR-1102", FieldName = "Sender Tracking ID", Start = 18, Length = 8, Required = true, Key = false, DataType = "A/N", Description = "Unique ID generated by the sender.", Type = "string", Format = "zfillnumeric")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "chr", FieldCode = "CHR-1103", FieldName = "Presort Mailing Job ID", Start = 26, Length = 8, Required = false, Key = false, DataType = "A/N", Description = "Job ID of Presort Mailing.", Type = "string", Format = "zfillnumeric")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "chr", FieldCode = "CHR-1104", FieldName = "Presort Mailing User License Code", Start = 34, Length = 4, Required = false, Key = false, DataType = "A/N", Description = "ULC documented in the Presort Mailing job referenced by Presort Mailing Job ID.  Must - begin with an alpha, be four characters, have no spaces, have no special characters, not be case sensitive.", Type = "string", Format = "leftjustify")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "chr", FieldCode = "CHR-1105", FieldName = "Mail Owner Contact Name", Start = 38, Length = 50, Required = false, Key = false, DataType = "A/N", Description = "Ex: John Smith. Name of individual for contact support for this Form.", Type = "string", Format = "leftjustify")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "chr", FieldCode = "CHR-1106", FieldName = "Mail Owner Company Name", Start = 88, Length = 50, Required = false, Key = false, DataType = "A/N", Description = "Name of Organization that owns the records and the Form.", Type = "string", Format = "leftjustify")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "chr", FieldCode = "CHR-1107", FieldName = "Mail Owner Secondary Address", Start = 138, Length = 50, Required = false, Key = false, DataType = "A/N", Description = "Secondary Address of Organization that owns the records and the Form.", Type = "string", Format = "leftjustify")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "chr", FieldCode = "CHR-1108", FieldName = "Mail Owner Primary Address", Start = 188, Length = 50, Required = false, Key = false, DataType = "A/N", Description = "Primary Address of Organization that owns the records and the Form.", Type = "string", Format = "leftjustify")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "chr", FieldCode = "CHR-1109", FieldName = "Mail Owner City", Start = 238, Length = 30, Required = false, Key = false, DataType = "A/N", Description = "City of Organization that owns the records and the Form.", Type = "string", Format = "leftjustify")]
		...
		/// States.
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "chr", FieldCode = "CHR-1110", FieldName = "Mail Owner State", Start = 268, Length = 2, Required = false, Key = false, DataType = "A/N", Description = "State of Organization that owns the records and the Form. Required for addresses in the United States.", Type = "string", Format = "leftjustify")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "chr", FieldCode = "CHR-1112", FieldName = "Mail Owner Province or State - International", Start = 279, Length = 20, Required = false, Key = false, DataType = "A/N", Description = "Province or State of owner's address.  Applicable for international addresses.", Type = "string", Format = "leftjustify")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "chr", FieldCode = "CHR-1113", FieldName = "Mail Owner Country Code", Start = 299, Length = 2, Required = false, Key = false, DataType = "A/N", Description = "Country Code of owner's address.  When required populated with two-character ISO Country Code. Used for international addresses only.", Type = "string", Format = "leftjustify")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "chr", FieldCode = "CHR-1114", FieldName = "Mailing Date", Start = 301, Length = 8, Required = false, Key = false, DataType = "N", Description = "The date on which postage is paid to the USPS and verification is completed.", Type = "date", Format = "YYYYMMDD")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "chr", FieldCode = "CHR-1115", FieldName = "Certificate Status", Start = 309, Length = 1, Required = false, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "chr", FieldCode = "CHR-1116", FieldName = "MPA ID", Start = 310, Length = 10, Required = true, Key = false, DataType = "A/N", Description = "Identify the permit paying for the Certificate of Mailing fees.", Type = "string", Format = "leftjustify", References = "MPA-1002")]
		...
		/// Reserve Option.
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "chr", FieldCode = "CHR-1117", FieldName = "Flex Option A", Start = 320, Length = 2, Required = false, Key = false, DataType = "A/N", Description = "Reserve Option.", Type = "string", Format = "leftjustify")]
		...
		/// Reserve Option.
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "chr", FieldCode = "CHR-1118", FieldName = "Flex Option B", Start = 322, Length = 2, Required = false, Key = false, DataType = "A/N", Description = "Reserve Option.", Type = "string", Format = "leftjustify")]
		...
		/// Reserve Option.
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "chr", FieldCode = "CHR-1119", FieldName = "Flex Option C", Start = 324, Length = 2, Required = false, Key = false, DataType = "A/N", Description = "Reserve Option.", Type = "string", Format = "leftjustify")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "chr", FieldCode = "CHR-1120", FieldName = "Reserve", Start = 326, Length = 20, Required = false, Key = false, DataType = "A/N", Description = "Reserved for future use.", Type = "string", Format = "leftjustify")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "chr", FieldCode = "CHR-2000", FieldName = "CHR Record Status", Start = 346, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		[MaildatField(Version = "24-1", Extension = "chr", FieldCode = "CHR-2000", FieldName = "CHR Record Status", Start = 346, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		[MaildatField(Version = "25-1", Extension = "chr", FieldCode = "CHR-2000", FieldName = "CHR Record Status", Start = 385, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		...
		/// Must be the # sign.
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "chr", FieldCode = "CHR-9999", FieldName = "Closing Character", Start = 347, Length = 1, Required = true, Key = false, DataType = "", Description = "Must be the # sign.", Type = "closing", Format = "leftjustify")]
