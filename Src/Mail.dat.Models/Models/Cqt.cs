...
namespace Mail.dat
{
	...
	[PrimaryKey("Id")]
	public partial class Cqt : MaildatEntity
	{
		/// <summary>
		/// Job ID (CQT-1001)
		/// </summary>
		...
		[Column("ThreeDigit5DigitContainerDivision", Order = 5)]
		[Required]
		[MaxLength(5)]
		[Comment("CQT-1007")]
		...
		[Column("MailPieceUnitID", Order = 6)]
		[Required]
		[MaxLength(5)]
		[Comment("CQT-1003")]
		...
		[Column("DestinationEntry", Order = 8)]
		[Required]
		[MaxLength(1)]
		...
		[Column("BarcodeDiscountOrSurchargeIndicator", Order = 10)]
		[Required]
		[MaxLength(1)]
		...
		[Column("PeriodicalsSubNonSubRequesterIndicator", Order = 11)]
		[Required]
		[MaxLength(1)]
		...
		[Column("PeriodicalsNotCountyInCounty", Order = 12)]
		[Required]
		[MaxLength(1)]
		[AllowedValues("I", "N", "O")]
		[Comment("CQT-1011")]
		...
		[Column("NumberOfCopies", Order = 13)]
		[Required]
		[Comment("CQT-1102")]
		[TypeConverter(typeof(MaildatIntegerConverter))]
		...
		[Column("NumberOfPieces", Order = 14)]
		[Required]
		[Comment("CQT-1103")]
		[TypeConverter(typeof(MaildatIntegerConverter))]
		...
		[Column("PeriodicalsCoPalletizationDiscountIndicator", Order = 15)]
		[Required]
		[MaxLength(1)]
		[AllowedValues("N", "Y")]
		[Comment("CQT-1107")]
		...
		[Column("ContainerChargeAllocation", Order = 16)]
		[Precision(6)]
		[Comment("CQT-1111")]
		...
		[Column("ServiceLevelIndicator", Order = 17)]
		[MaxLength(1)]
		[AllowedValues("B", "F", "O")]
		[Comment("CQT-1112")]
		...
		[Column("SimplifiedAddressIndicator", Order = 18)]
		[MaxLength(1)]
		...
		[Column("CQTRecordStatus", Order = 19)]
		[Required]
		[MaxLength(1)]
		...
		[Column("ReserveCQT1106", Order = 20)]
		[MaxLength(19)]
		[Comment("CQT-1106")]
		...
		[Column("ClosingCharacter", Order = 21)]
		[Required]
		[MaxLength(1)]
		[AllowedValues("#")]
		[Comment("CQT-9999")]
		...
		protected override ILoadError[] OnLoadData(int fileLineNumber, byte[] line)
		{
			...
			this.JobID = line.Parse<Cqt, string>(p => p.JobID, returnValue);
			this.CQTDatabaseID = line.Parse<Cqt, int>(p => p.CQTDatabaseID, returnValue);
			this.ContainerID = line.Parse<Cqt, int>(p => p.ContainerID, returnValue);
			this.ThreeDigit5DigitContainerDivision = line.Parse<Cqt, string>(p => p.ThreeDigit5DigitContainerDivision, returnValue);
			this.MailPieceUnitID = line.Parse<Cqt, string>(p => p.MailPieceUnitID, returnValue);
			this.Zone = line.Parse<Cqt, string>(p => p.Zone, returnValue);
			this.DestinationEntry = line.Parse<Cqt, string>(p => p.DestinationEntry, returnValue);
			this.RateCategory = line.Parse<Cqt, string>(p => p.RateCategory, returnValue);
			this.BarcodeDiscountOrSurchargeIndicator = line.Parse<Cqt, string>(p => p.BarcodeDiscountOrSurchargeIndicator, returnValue);
			this.PeriodicalsSubNonSubRequesterIndicator = line.Parse<Cqt, string>(p => p.PeriodicalsSubNonSubRequesterIndicator, returnValue);
			this.PeriodicalsNotCountyInCounty = line.Parse<Cqt, string>(p => p.PeriodicalsNotCountyInCounty, returnValue);
			this.NumberOfCopies = line.Parse<Cqt, int>(p => p.NumberOfCopies, returnValue);
			this.NumberOfPieces = line.Parse<Cqt, int>(p => p.NumberOfPieces, returnValue);
			this.PeriodicalsCoPalletizationDiscountIndicator = line.Parse<Cqt, string>(p => p.PeriodicalsCoPalletizationDiscountIndicator, returnValue);
			this.ContainerChargeAllocation = line.Parse<Cqt, decimal>(p => p.ContainerChargeAllocation, returnValue);
			this.ServiceLevelIndicator = line.Parse<Cqt, string>(p => p.ServiceLevelIndicator, returnValue);
			this.SimplifiedAddressIndicator = line.Parse<Cqt, string>(p => p.SimplifiedAddressIndicator, returnValue);
			this.CQTRecordStatus = line.Parse<Cqt, string>(p => p.CQTRecordStatus, returnValue);
			this.ReserveCQT1106 = line.Parse<Cqt, string>(p => p.ReserveCQT1106, returnValue);
			this.ClosingCharacter = line.Parse<Cqt, string>(p => p.ClosingCharacter, returnValue);
