...
namespace Mail.dat
{
	...
	[PrimaryKey("Id")]
	public partial class Csm : MaildatEntity
	{
		/// <summary>
		/// Job ID (CSM-1001)
		/// </summary>
		...
		[Column("DisplayContainerID", Order = 6)]
		[Required]
		[MaxLength(6)]
		[Comment("CSM-1101")]
		...
		[Column("ContainerGroupingDescription", Order = 7)]
		[MaxLength(9)]
		[Comment("CSM-1102")]
		...
		[Column("ContainerDestinationZip", Order = 8)]
		[Required]
		[MaxLength(6)]
		[Comment("CSM-1103")]
		...
		[Column("EntryPointForEntryDiscountPostalCode", Order = 10)]
		[Required]
		[MaxLength(6)]
		[Comment("CSM-1105")]
		...
		[Column("EntryPointForEntryDiscountFacilityType", Order = 11)]
		[Required]
		[MaxLength(2)]
		...
		[Column("EntryPointActualDeliveryLocaleKey", Order = 12)]
		[Required]
		[MaxLength(9)]
		[Comment("CSM-1167")]
		...
		[Column("EntryPointActualDeliveryPostalCode", Order = 13)]
		[Required]
		[MaxLength(9)]
		[Comment("CSM-1168")]
		...
		[Column("ParentContainerReferenceID", Order = 14)]
		[Comment("CSM-1109")]
		[TypeConverter(typeof(MaildatIntegerConverter))]
		...
		[Column("TruckOrDispatchNumber", Order = 15)]
		[MaxLength(20)]
		[Comment("CSM-1110")]
		...
		[Column("StopDesignator", Order = 16)]
		[MaxLength(2)]
		[Comment("CSM-1111")]
		...
		[Column("ReservationNumber", Order = 17)]
		[MaxLength(15)]
		[Comment("CSM-1112")]
		...
		[Column("ActualContainerShipDate", Order = 18)]
		[Comment("CSM-1113")]
		...
		[Column("ActualContainerShipTime", Order = 19)]
		[Comment("CSM-1164")]
		...
		[Column("ScheduledPickUpDate", Order = 20)]
		[Comment("CSM-1177")]
		[TypeConverter(typeof(MaildatDateConverter))]
		...
		[Column("ScheduledPickUpTime", Order = 21)]
		[Comment("CSM-1178")]
		[TypeConverter(typeof(MaildatTimeConverter))]
		...
		[Column("ScheduledInHomeDate", Order = 22)]
		[Comment("CSM-1115")]
		[TypeConverter(typeof(MaildatDateConverter))]
		...
		[Column("AdditionalInHomeRange", Order = 23)]
		[Comment("CSM-1116")]
		[TypeConverter(typeof(MaildatIntegerConverter))]
		...
		[Column("ScheduledInductionStartDate", Order = 24)]
		[Comment("CSM-1117")]
		[TypeConverter(typeof(MaildatDateConverter))]
		...
		[Column("ScheduledInductionStartTime", Order = 25)]
		[Comment("CSM-1118")]
		[TypeConverter(typeof(MaildatTimeConverter))]
		...
		[Column("ScheduledInductionEndDate", Order = 26)]
		[Comment("CSM-2001")]
		[TypeConverter(typeof(MaildatDateConverter))]
		...
		[Column("ScheduledInductionEndTime", Order = 27)]
		[Comment("CSM-2002")]
		[TypeConverter(typeof(MaildatTimeConverter))]
		...
		[Column("ActualInductionDate", Order = 28)]
		[Comment("CSM-1179")]
		[TypeConverter(typeof(MaildatDateConverter))]
		...
		[Column("ActualInductionTime", Order = 29)]
		[Comment("CSM-1180")]
		[TypeConverter(typeof(MaildatTimeConverter))]
		...
		[Column("PostageStatementMailingDate", Order = 30)]
		[Comment("CSM-1184")]
		[TypeConverter(typeof(MaildatDateConverter))]
		...
		[Column("PostageStatementMailingTime", Order = 31)]
		[Comment("CSM-1183")]
		[TypeConverter(typeof(MaildatTimeConverter))]
		...
		[Column("NumberOfCopies", Order = 32)]
		[Required]
		[Comment("CSM-1120")]
		[TypeConverter(typeof(MaildatIntegerConverter))]
		...
		[Column("NumberOfPieces", Order = 33)]
		[Required]
		[Comment("CSM-1121")]
		[TypeConverter(typeof(MaildatIntegerConverter))]
		...
		[Column("TotalWeightProductOnly", Order = 34)]
		[Required]
		[Precision(4)]
		[Comment("CSM-1122")]
		...
		[Column("UserContainerID", Order = 35)]
		[MaxLength(12)]
		[Comment("CSM-1123")]
		...
		[Column("ContainerStatus", Order = 36)]
		[MaxLength(1)]
		...
		[Column("IncludedInOtherDocumentation", Order = 37)]
		[MaxLength(1)]
		[AllowedValues("I", "L", "O")]
		[Comment("CSM-1181")]
		...
		[Column("TrayPreparationType", Order = 38)]
		[Required]
		[MaxLength(1)]
		...
		[Column("TransShipBillOfLadingNumber", Order = 39)]
		[MaxLength(10)]
		[Comment("CSM-1130")]
		...
		[Column("SiblingContainerIndicator", Order = 40)]
		[MaxLength(1)]
		[AllowedValues("Y")]
		[Comment("CSM-1132")]
		...
		[Column("SiblingContainerReferenceID", Order = 41)]
		[Comment("CSM-1133")]
		[TypeConverter(typeof(MaildatIntegerConverter))]
		...
		[Column("PostageGroupingID", Order = 42)]
		[MaxLength(8)]
		[Comment("CSM-1136")]
		...
		[Column("ContainerGrossWeight", Order = 43)]
		[Precision(4)]
		[Comment("CSM-1137")]
		[TypeConverter(typeof(MaildatDecimalConverter))]
		...
		[Column("ContainerHeight", Order = 44)]
		[Comment("CSM-1139")]
		[TypeConverter(typeof(MaildatIntegerConverter))]
		...
		[Column("EMD8125ASNBarcode", Order = 45)]
		[MaxLength(20)]
		[Comment("CSM-1141")]
		...
		[Column("TransportationCarrierID", Order = 46)]
		[MaxLength(15)]
		[Comment("CSM-1142")]
		...
		[Column("FASTSchedulerID", Order = 48)]
		[Comment("CSM-1163")]
		[TypeConverter(typeof(MaildatIntegerConverter))]
		...
		[Column("CSASeparationID", Order = 50)]
		[Comment("CSM-1175")]
		[TypeConverter(typeof(MaildatIntegerConverter))]
		...
		[Column("ScheduledShipDate", Order = 51)]
		[Comment("CSM-1172")]
		[TypeConverter(typeof(MaildatDateConverter))]
		...
		[Column("ScheduledShipTime", Order = 52)]
		[Comment("CSM-1173")]
		[TypeConverter(typeof(MaildatTimeConverter))]
		...
		[Column("DMMSectionDefiningContainerPreparation", Order = 53)]
		[MaxLength(12)]
		[Comment("CSM-1147")]
		...
		[Column("LabelIMContainerOrIMTrayBarcodeFinal", Order = 54)]
		[MaxLength(24)]
		[Comment("CSM-1150")]
		...
		[Column("LabelIMContainerOrIMTrayBarcodeOriginal", Order = 55)]
		[MaxLength(24)]
		[Comment("CSM-1198")]
		...
		[Column("LabelDestinationLine1", Order = 56)]
		[MaxLength(30)]
		[Comment("CSM-1152")]
		...
		[Column("LabelDestinationLine2", Order = 57)]
		[MaxLength(30)]
		[Comment("CSM-1153")]
		...
		[Column("LabelContentsLine1", Order = 58)]
		[MaxLength(30)]
		[Comment("CSM-1154")]
		...
		[Column("LabelContentsLine2", Order = 59)]
		[MaxLength(20)]
		[Comment("CSM-1155")]
		...
		[Column("LabelEntryOriginPointLine", Order = 60)]
		[MaxLength(30)]
		[Comment("CSM-1156")]
		...
		[Column("LabelUserInformationLine1", Order = 61)]
		[MaxLength(40)]
		[Comment("CSM-1157")]
		...
		[Column("LabelUserInformationLine2", Order = 62)]
		[MaxLength(40)]
		[Comment("CSM-1158")]
		...
		[Column("LabelContainerLabelCINCode", Order = 63)]
		[MaxLength(4)]
		[Comment("CSM-1159")]
		...
		[Column("UserOptionField", Order = 64)]
		[MaxLength(20)]
		[Comment("CSM-1176")]
		...
		[Column("EInductionIndicator", Order = 65)]
		[MaxLength(1)]
		[AllowedValues("Y")]
		[Comment("CSM-1186")]
		...
		[Column("CSAAgreementID", Order = 66)]
		[MaxLength(10)]
		[Comment("CSM-1187")]
		...
		[Column("PresortLabelingListEffectiveDate", Order = 67)]
		[Required]
		[Comment("CSM-1189")]
		[TypeConverter(typeof(MaildatDateConverter))]
		...
		[Column("LastUsedLabelingListEffectiveDate", Order = 68)]
		[Required]
		[Comment("CSM-1190")]
		[TypeConverter(typeof(MaildatDateConverter))]
		...
		[Column("PresortCityStatePublicationDate", Order = 69)]
		[Required]
		[Comment("CSM-1191")]
		[TypeConverter(typeof(MaildatDateConverter))]
		...
		[Column("LastUsedCityStatePublicationDate", Order = 70)]
		[Required]
		[Comment("CSM-1192")]
		[TypeConverter(typeof(MaildatDateConverter))]
		...
		[Column("PresortZoneChartMatrixPublicationDate", Order = 71)]
		[Required]
		[Comment("CSM-1193")]
		[TypeConverter(typeof(MaildatDateConverter))]
		...
		[Column("LastUsedZoneChartMatrixPublicationDate", Order = 72)]
		[Required]
		[Comment("CSM-1194")]
		[TypeConverter(typeof(MaildatDateConverter))]
		...
		[Column("LastUsedMailDirectionPublicationDate", Order = 73)]
		[Required]
		[Comment("CSM-1195")]
		[TypeConverter(typeof(MaildatDateConverter))]
		...
		[Column("SupplementalPhysicalContainerID", Order = 74)]
		[Comment("CSM-1196")]
		[TypeConverter(typeof(MaildatIntegerConverter))]
		...
		[Column("AcceptMisshipped", Order = 75)]
		[MaxLength(1)]
		[AllowedValues("Y")]
		[Comment("CSM-1188")]
		...
		[Column("ReferenceableMailStartDate", Order = 76)]
		[Comment("CSM-1199")]
		[TypeConverter(typeof(MaildatDateConverter))]
		...
		[Column("ReferenceableMailEndDate", Order = 77)]
		[Comment("CSM-1200")]
		[TypeConverter(typeof(MaildatDateConverter))]
		...
		[Column("CSMRecordStatus", Order = 78)]
		[Required]
		[MaxLength(1)]
		...
		[Column("ReserveCSM1134", Order = 79)]
		[MaxLength(39)]
		[Comment("CSM-1134")]
		...
		[Column("ClosingCharacter", Order = 80)]
		[Required]
		[MaxLength(1)]
		[AllowedValues("#")]
		[Comment("CSM-9999")]
		...
		protected override ILoadError[] OnLoadData(int fileLineNumber, byte[] line)
		{
			...
			this.JobID = line.Parse<Csm, string>(p => p.JobID, returnValue);
			this.SegmentID = line.Parse<Csm, string>(p => p.SegmentID, returnValue);
			this.ContainerType = line.Parse<Csm, string>(p => p.ContainerType, returnValue);
			this.ContainerID = line.Parse<Csm, int>(p => p.ContainerID, returnValue);
			this.DisplayContainerID = line.Parse<Csm, string>(p => p.DisplayContainerID, returnValue);
			this.ContainerGroupingDescription = line.Parse<Csm, string>(p => p.ContainerGroupingDescription, returnValue);
			this.ContainerDestinationZip = line.Parse<Csm, string>(p => p.ContainerDestinationZip, returnValue);
			this.ContainerLevel = line.Parse<Csm, string>(p => p.ContainerLevel, returnValue);
			this.EntryPointForEntryDiscountPostalCode = line.Parse<Csm, string>(p => p.EntryPointForEntryDiscountPostalCode, returnValue);
			this.EntryPointForEntryDiscountFacilityType = line.Parse<Csm, string>(p => p.EntryPointForEntryDiscountFacilityType, returnValue);
			this.EntryPointActualDeliveryLocaleKey = line.Parse<Csm, string>(p => p.EntryPointActualDeliveryLocaleKey, returnValue);
			this.EntryPointActualDeliveryPostalCode = line.Parse<Csm, string>(p => p.EntryPointActualDeliveryPostalCode, returnValue);
			this.ParentContainerReferenceID = line.Parse<Csm, int>(p => p.ParentContainerReferenceID, returnValue);
			this.TruckOrDispatchNumber = line.Parse<Csm, string>(p => p.TruckOrDispatchNumber, returnValue);
			this.StopDesignator = line.Parse<Csm, string>(p => p.StopDesignator, returnValue);
			this.ReservationNumber = line.Parse<Csm, string>(p => p.ReservationNumber, returnValue);
			this.ActualContainerShipDate = line.Parse<Csm, DateOnly?>(p => p.ActualContainerShipDate, returnValue);
			this.ActualContainerShipTime = line.Parse<Csm, TimeOnly?>(p => p.ActualContainerShipTime, returnValue);
			this.ScheduledPickUpDate = line.Parse<Csm, DateOnly?>(p => p.ScheduledPickUpDate, returnValue);
			this.ScheduledPickUpTime = line.Parse<Csm, TimeOnly?>(p => p.ScheduledPickUpTime, returnValue);
			this.ScheduledInHomeDate = line.Parse<Csm, DateOnly?>(p => p.ScheduledInHomeDate, returnValue);
			this.AdditionalInHomeRange = line.Parse<Csm, int>(p => p.AdditionalInHomeRange, returnValue);
			this.ScheduledInductionStartDate = line.Parse<Csm, DateOnly?>(p => p.ScheduledInductionStartDate, returnValue);
			this.ScheduledInductionStartTime = line.Parse<Csm, TimeOnly?>(p => p.ScheduledInductionStartTime, returnValue);
			this.ScheduledInductionEndDate = line.Parse<Csm, DateOnly?>(p => p.ScheduledInductionEndDate, returnValue);
			this.ScheduledInductionEndTime = line.Parse<Csm, TimeOnly?>(p => p.ScheduledInductionEndTime, returnValue);
			this.ActualInductionDate = line.Parse<Csm, DateOnly?>(p => p.ActualInductionDate, returnValue);
			this.ActualInductionTime = line.Parse<Csm, TimeOnly?>(p => p.ActualInductionTime, returnValue);
			this.PostageStatementMailingDate = line.Parse<Csm, DateOnly?>(p => p.PostageStatementMailingDate, returnValue);
			this.PostageStatementMailingTime = line.Parse<Csm, TimeOnly?>(p => p.PostageStatementMailingTime, returnValue);
			this.NumberOfCopies = line.Parse<Csm, int>(p => p.NumberOfCopies, returnValue);
			this.NumberOfPieces = line.Parse<Csm, int>(p => p.NumberOfPieces, returnValue);
			this.TotalWeightProductOnly = line.Parse<Csm, decimal>(p => p.TotalWeightProductOnly, returnValue);
			this.UserContainerID = line.Parse<Csm, string>(p => p.UserContainerID, returnValue);
			this.ContainerStatus = line.Parse<Csm, string>(p => p.ContainerStatus, returnValue);
			this.IncludedInOtherDocumentation = line.Parse<Csm, string>(p => p.IncludedInOtherDocumentation, returnValue);
			this.TrayPreparationType = line.Parse<Csm, string>(p => p.TrayPreparationType, returnValue);
			this.TransShipBillOfLadingNumber = line.Parse<Csm, string>(p => p.TransShipBillOfLadingNumber, returnValue);
			this.SiblingContainerIndicator = line.Parse<Csm, string>(p => p.SiblingContainerIndicator, returnValue);
			this.SiblingContainerReferenceID = line.Parse<Csm, int>(p => p.SiblingContainerReferenceID, returnValue);
			this.PostageGroupingID = line.Parse<Csm, string>(p => p.PostageGroupingID, returnValue);
			this.ContainerGrossWeight = line.Parse<Csm, decimal>(p => p.ContainerGrossWeight, returnValue);
			this.ContainerHeight = line.Parse<Csm, int>(p => p.ContainerHeight, returnValue);
			this.EMD8125ASNBarcode = line.Parse<Csm, string>(p => p.EMD8125ASNBarcode, returnValue);
			this.TransportationCarrierID = line.Parse<Csm, string>(p => p.TransportationCarrierID, returnValue);
			this.FASTContentID = line.Parse<Csm, string>(p => p.FASTContentID, returnValue);
			this.FASTSchedulerID = line.Parse<Csm, int>(p => p.FASTSchedulerID, returnValue);
			this.USPSPickUp = line.Parse<Csm, string>(p => p.USPSPickUp, returnValue);
			this.CSASeparationID = line.Parse<Csm, int>(p => p.CSASeparationID, returnValue);
			this.ScheduledShipDate = line.Parse<Csm, DateOnly?>(p => p.ScheduledShipDate, returnValue);
			this.ScheduledShipTime = line.Parse<Csm, TimeOnly?>(p => p.ScheduledShipTime, returnValue);
			this.DMMSectionDefiningContainerPreparation = line.Parse<Csm, string>(p => p.DMMSectionDefiningContainerPreparation, returnValue);
			this.LabelIMContainerOrIMTrayBarcodeFinal = line.Parse<Csm, string>(p => p.LabelIMContainerOrIMTrayBarcodeFinal, returnValue);
			this.LabelIMContainerOrIMTrayBarcodeOriginal = line.Parse<Csm, string>(p => p.LabelIMContainerOrIMTrayBarcodeOriginal, returnValue);
			this.LabelDestinationLine1 = line.Parse<Csm, string>(p => p.LabelDestinationLine1, returnValue);
			this.LabelDestinationLine2 = line.Parse<Csm, string>(p => p.LabelDestinationLine2, returnValue);
			this.LabelContentsLine1 = line.Parse<Csm, string>(p => p.LabelContentsLine1, returnValue);
			this.LabelContentsLine2 = line.Parse<Csm, string>(p => p.LabelContentsLine2, returnValue);
			this.LabelEntryOriginPointLine = line.Parse<Csm, string>(p => p.LabelEntryOriginPointLine, returnValue);
			this.LabelUserInformationLine1 = line.Parse<Csm, string>(p => p.LabelUserInformationLine1, returnValue);
			this.LabelUserInformationLine2 = line.Parse<Csm, string>(p => p.LabelUserInformationLine2, returnValue);
			this.LabelContainerLabelCINCode = line.Parse<Csm, string>(p => p.LabelContainerLabelCINCode, returnValue);
			this.UserOptionField = line.Parse<Csm, string>(p => p.UserOptionField, returnValue);
			this.EInductionIndicator = line.Parse<Csm, string>(p => p.EInductionIndicator, returnValue);
			this.CSAAgreementID = line.Parse<Csm, string>(p => p.CSAAgreementID, returnValue);
			this.PresortLabelingListEffectiveDate = line.Parse<Csm, DateOnly>(p => p.PresortLabelingListEffectiveDate, returnValue);
			this.LastUsedLabelingListEffectiveDate = line.Parse<Csm, DateOnly>(p => p.LastUsedLabelingListEffectiveDate, returnValue);
			this.PresortCityStatePublicationDate = line.Parse<Csm, DateOnly>(p => p.PresortCityStatePublicationDate, returnValue);
			this.LastUsedCityStatePublicationDate = line.Parse<Csm, DateOnly>(p => p.LastUsedCityStatePublicationDate, returnValue);
			this.PresortZoneChartMatrixPublicationDate = line.Parse<Csm, DateOnly>(p => p.PresortZoneChartMatrixPublicationDate, returnValue);
			this.LastUsedZoneChartMatrixPublicationDate = line.Parse<Csm, DateOnly>(p => p.LastUsedZoneChartMatrixPublicationDate, returnValue);
			this.LastUsedMailDirectionPublicationDate = line.Parse<Csm, DateOnly>(p => p.LastUsedMailDirectionPublicationDate, returnValue);
			this.SupplementalPhysicalContainerID = line.Parse<Csm, int>(p => p.SupplementalPhysicalContainerID, returnValue);
			this.AcceptMisshipped = line.Parse<Csm, string>(p => p.AcceptMisshipped, returnValue);
			this.ReferenceableMailStartDate = line.Parse<Csm, DateOnly?>(p => p.ReferenceableMailStartDate, returnValue);
			this.ReferenceableMailEndDate = line.Parse<Csm, DateOnly?>(p => p.ReferenceableMailEndDate, returnValue);
			this.CSMRecordStatus = line.Parse<Csm, string>(p => p.CSMRecordStatus, returnValue);
			this.ReserveCSM1134 = line.Parse<Csm, string>(p => p.ReserveCSM1134, returnValue);
			this.ClosingCharacter = line.Parse<Csm, string>(p => p.ClosingCharacter, returnValue);
