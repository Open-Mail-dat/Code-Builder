...
namespace Mail.dat
{
	...
	public partial class Rmb : MaildatEntity, IRmb 
	{
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "rmb", FieldCode = "RMB-1001", FieldName = "Job ID", Start = 1, Length = 8, Required = true, Key = true, DataType = "A/N", Description = "See Header File's Job ID definition.", Type = "string", Format = "zfillnumeric", References = "HDR-1001")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "rmb", FieldCode = "RMB-2000", FieldName = "RMB Record Status", Start = 315, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		[MaildatField(Version = "24-1", Extension = "rmb", FieldCode = "RMB-2000", FieldName = "RMB Record Status", Start = 315, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		[MaildatField(Version = "25-1", Extension = "rmb", FieldCode = "RMB-2000", FieldName = "RMB Record Status", Start = 315, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
