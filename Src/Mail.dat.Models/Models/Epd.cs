...
namespace Mail.dat
{
	...
	[MaildatFile(Version = "24-1", Revision = "1.3", Extension = "epd", File = "Extra Piece Detail", Summary = "CRID for Move update charges.", Description = "CRID for Move update charges. Records identify third party move update entities that should be invoiced.", LineLength = 45, ClosingCharacter = "#")]
	[MaildatFile(Version = "25-1", Revision = "0.3", Extension = "epd", File = "Extra Piece Detail", Summary = "CRID for Move update charges.", Description = "CRID for Move update charges. Records identify third party move update entities that should be invoiced.", LineLength = 45, ClosingCharacter = "#")]
	...
	public partial class Epd : MaildatEntity, IEpd 
	{
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "epd", FieldCode = "EPD-1001", FieldName = "Job ID", Start = 1, Length = 8, Required = true, Key = true, DataType = "A/N", Description = "(Zero fill prior to numeric, if numeric only). See Header File's Job ID definition.", Type = "string", Format = "zfillnumeric", References = "HDR-1001")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "epd", FieldCode = "EPD-2000", FieldName = "EPD Record Status", Start = 44, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		[MaildatField(Version = "24-1", Extension = "epd", FieldCode = "EPD-2000", FieldName = "EPD Record Status", Start = 44, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		[MaildatField(Version = "25-1", Extension = "epd", FieldCode = "EPD-2000", FieldName = "EPD Record Status", Start = 44, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
