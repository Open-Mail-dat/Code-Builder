...
namespace Mail.dat
{
	...
	[MaildatFile(Version = "24-1", Revision = "1.3", Extension = "oci", File = "Original Container", Summary = "Links new container with an original container.", Description = "Links new container with an original container. Allows customers to tie or link container information between Jobs from Mail.dat and Mail.XML.", LineLength = 120, ClosingCharacter = "#")]
	...
	public partial class Oci : MaildatEntity, IOci 
	{
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "oci", FieldCode = "OCI-1001", FieldName = "Job ID", Start = 1, Length = 8, Required = true, Key = true, DataType = "A/N", Description = "", Type = "string", Format = "zfillnumeric", References = "HDR-1001")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "oci", FieldCode = "OCI-2000", FieldName = "OCI Record Status", Start = 103, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		[MaildatField(Version = "24-1", Extension = "oci", FieldCode = "OCI-2000", FieldName = "OCI Record Status", Start = 103, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		[MaildatField(Version = "25-1", Extension = "oci", FieldCode = "OCI-2000", FieldName = "OCI Record Status", Start = 103, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "oci", FieldCode = "OCI-1110", FieldName = "Reserve", Start = 104, Length = 16, Required = false, Key = false, DataType = "A/N", Description = "", Type = "string", Format = "leftjustify")]
