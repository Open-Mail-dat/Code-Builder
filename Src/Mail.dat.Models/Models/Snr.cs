...
namespace Mail.dat
{
	...
	[PrimaryKey("Id")]
	public partial class Snr : MaildatEntity
	{
		/// <summary>
		/// Job ID (SNR-1001)
		/// </summary>
		...
		[Column("SeedNameReceivedDate", Order = 8)]
		[Comment("SNR-1101")]
		...
		[Column("ReportedSeedCondition", Order = 11)]
		[MaxLength(1)]
		...
		[Column("UserOptionField", Order = 13)]
		[MaxLength(20)]
		[Comment("SNR-1110")]
		...
		[Column("SNRRecordStatus", Order = 14)]
		[Required]
		[MaxLength(1)]
		...
		[Column("ReserveSNR1103", Order = 15)]
		[MaxLength(18)]
		[Comment("SNR-1103")]
		...
		protected override ILoadError[] OnLoadData(int fileLineNumber, byte[] line)
		{
			...
			this.JobID = line.Parse<Snr, string>(p => p.JobID, returnValue);
			this.ContainerID = line.Parse<Snr, int>(p => p.ContainerID, returnValue);
			this.PackageID = line.Parse<Snr, string>(p => p.PackageID, returnValue);
			this.MailPieceUnitID = line.Parse<Snr, string>(p => p.MailPieceUnitID, returnValue);
			this.SeedNameID = line.Parse<Snr, string>(p => p.SeedNameID, returnValue);
			this.VersionKeyCode = line.Parse<Snr, string>(p => p.VersionKeyCode, returnValue);
			this.SeedNameReceivedDate = line.Parse<Snr, DateOnly?>(p => p.SeedNameReceivedDate, returnValue);
			this.SeedType = line.Parse<Snr, string>(p => p.SeedType, returnValue);
			this.PieceBarcode = line.Parse<Snr, string>(p => p.PieceBarcode, returnValue);
			this.ReportedSeedCondition = line.Parse<Snr, string>(p => p.ReportedSeedCondition, returnValue);
			this.IMBarcode = line.Parse<Snr, string>(p => p.IMBarcode, returnValue);
			this.UserOptionField = line.Parse<Snr, string>(p => p.UserOptionField, returnValue);
			this.SNRRecordStatus = line.Parse<Snr, string>(p => p.SNRRecordStatus, returnValue);
			this.ReserveSNR1103 = line.Parse<Snr, string>(p => p.ReserveSNR1103, returnValue);
			this.ClosingCharacter = line.Parse<Snr, string>(p => p.ClosingCharacter, returnValue);
