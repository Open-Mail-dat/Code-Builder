...
namespace Mail.dat
{
	...
	[PrimaryKey("Id")]
	public partial class Rms : MaildatEntity
	{
		/// <summary>
		/// Job ID (RMS-1001)
		/// </summary>
		...
		[Column("CampaignSerialGrouping", Order = 7)]
		[Required]
		[MaxLength(1)]
		[AllowedValues("C", "S")]
		[Comment("RMS-1005")]
		...
		[Column("CampaignSharingIndicator", Order = 11)]
		[Required]
		[MaxLength(1)]
		[AllowedValues("N", "Y")]
		[Comment("RMS-1010")]
		...
		[Column("CampaignTargetURLParametersIndicator", Order = 12)]
		[Required]
		[MaxLength(1)]
		[AllowedValues("N", "Y")]
		[Comment("RMS-1011")]
		...
		[Column("CampaignMailOwnerCRID", Order = 13)]
		[Required]
		[MaxLength(12)]
		[Comment("RMS-1012")]
		...
		[Column("CampaignMailPreparerCRID", Order = 14)]
		[MaxLength(12)]
		[Comment("RMS-1013")]
		...
		[Column("CampaignProcessingCategory", Order = 15)]
		[Required]
		[MaxLength(2)]
		...
		[Column("ReserveRMS1020", Order = 21)]
		[MaxLength(20)]
		[Comment("RMS-1020")]
		...
		[Column("RMSRecordStatus", Order = 22)]
		[Required]
		[MaxLength(1)]
		...
		protected override ILoadError[] OnLoadData(int fileLineNumber, byte[] line)
		{
			...
			this.JobID = line.Parse<Rms, string>(p => p.JobID, returnValue);
			this.RMSID = line.Parse<Rms, string>(p => p.RMSID, returnValue);
			this.ReserveRMS1009 = line.Parse<Rms, string>(p => p.ReserveRMS1009, returnValue);
			this.CampaignTitle = line.Parse<Rms, string>(p => p.CampaignTitle, returnValue);
			this.CampaignCode = line.Parse<Rms, string>(p => p.CampaignCode, returnValue);
			this.CampaignSerialGrouping = line.Parse<Rms, string>(p => p.CampaignSerialGrouping, returnValue);
			this.DisplayName = line.Parse<Rms, string>(p => p.DisplayName, returnValue);
			this.DateStart = line.Parse<Rms, DateOnly?>(p => p.DateStart, returnValue);
			this.DateEnd = line.Parse<Rms, DateOnly?>(p => p.DateEnd, returnValue);
			this.CampaignSharingIndicator = line.Parse<Rms, string>(p => p.CampaignSharingIndicator, returnValue);
			this.CampaignTargetURLParametersIndicator = line.Parse<Rms, string>(p => p.CampaignTargetURLParametersIndicator, returnValue);
			this.CampaignMailOwnerCRID = line.Parse<Rms, string>(p => p.CampaignMailOwnerCRID, returnValue);
			this.CampaignMailPreparerCRID = line.Parse<Rms, string>(p => p.CampaignMailPreparerCRID, returnValue);
			this.CampaignProcessingCategory = line.Parse<Rms, string>(p => p.CampaignProcessingCategory, returnValue);
			this.FlexOptionA = line.Parse<Rms, string>(p => p.FlexOptionA, returnValue);
			this.FlexOptionB = line.Parse<Rms, string>(p => p.FlexOptionB, returnValue);
			this.FlexOptionC = line.Parse<Rms, string>(p => p.FlexOptionC, returnValue);
			this.FlexOptionD = line.Parse<Rms, string>(p => p.FlexOptionD, returnValue);
			this.FlexOptionE = line.Parse<Rms, string>(p => p.FlexOptionE, returnValue);
			this.ReserveRMS1020 = line.Parse<Rms, string>(p => p.ReserveRMS1020, returnValue);
			this.RMSRecordStatus = line.Parse<Rms, string>(p => p.RMSRecordStatus, returnValue);
			this.ClosingCharacter = line.Parse<Rms, string>(p => p.ClosingCharacter, returnValue);
