...
namespace Mail.dat
{
	...
	/// </summary>
	[MaildatFile(Version = "23-1", Revision = "0.5", Extension = "rms", File = "REFERENCEABLE MAIL SUMMARY RECORD", Summary = "Referenceable Mail Summary to provide digital Content.", Description = "Referenceable Mail Summary to provide digital Content.", LineLength = 235, ClosingCharacter = "#")]
	[MaildatFile(Version = "24-1", Revision = "1.3", Extension = "rms", File = "REFERENCEABLE MAIL SUMMARY RECORD", Summary = "Referenceable Mail Summary to provide digital Content.", Description = "Referenceable Mail Summary to provide digital Content. Records identify a summary of campaigns that can be tied to barcode records.", LineLength = 235, ClosingCharacter = "#")]
	[MaildatFile(Version = "25-1", Revision = "0.3", Extension = "rms", File = "REFERENCEABLE MAIL SUMMARY RECORD", Summary = "Referenceable Mail Summary to provide digital Content.", Description = "Referenceable Mail Summary to provide digital Content. Records identify a summary of campaigns that can be tied to barcode records.", LineLength = 235, ClosingCharacter = "#")]
	...
	public partial class Rms : MaildatEntity, IRms 
	{
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "rms", FieldCode = "RMS-1001", FieldName = "Job ID", Start = 1, Length = 8, Required = true, Key = true, DataType = "A/N", Description = "See Header File's Job ID definition.", Type = "string", Format = "zfillnumeric", References = "HDR-1001")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "rms", FieldCode = "RMS-1009", FieldName = "Reserve", Start = 17, Length = 22, Required = false, Key = false, DataType = "A/N", Description = "For future use.", Type = "string", Format = "leftjustify")]
		...
		/// </summary>
		[MaildatField(Version = "23-1", Extension = "rms", FieldCode = "RMS-2000", FieldName = "RMS Record Status", Start = 234, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		[MaildatField(Version = "24-1", Extension = "rms", FieldCode = "RMS-2000", FieldName = "RMS Record Status", Start = 234, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
		[MaildatField(Version = "25-1", Extension = "rms", FieldCode = "RMS-2000", FieldName = "RMS Record Status", Start = 234, Length = 1, Required = true, Key = false, DataType = "A/N", Description = "", Type = "enum", Format = "leftjustify")]
