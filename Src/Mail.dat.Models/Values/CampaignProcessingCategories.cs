...
namespace Mail.dat
{
	...
	public class CampaignProcessingCategories : MaildatValues 
	{
		...
		protected override void OnInitializeValues()
		{
			...
			this.Add(new MaildatValue() { Version = "23-1", Key = "IR", FileExtension = "rms", Description = "Irregular Parcel", FieldCode = "RMS-1014", FieldName = "CampaignProcessingCategory" });
			...
			this.Add(new MaildatValue() { Version = "23-1", Key = "NP", FileExtension = "rms", Description = "Non-Machinable Parcel", FieldCode = "RMS-1014", FieldName = "CampaignProcessingCategory" });
